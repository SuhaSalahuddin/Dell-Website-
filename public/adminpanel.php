...
<body>
    ...
    <header>
        ...
        <h2 style='color:white; text-align:center; font-weight: bold;'>Admin Panel - Insert Data</h2>
    </header>
...
$EmpName=$_POST['EmployeeName'];
$EmpDesignation=$_POST['EmployeeDesignation'];
